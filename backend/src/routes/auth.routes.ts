    ...
    if (role === ROLES.STUDENT) {
      const updated = await prisma.studentProfile.update({
        ...
        data: {
          ...
          alternateEmail: body.alternateEmail !== undefined ? body.alternateEmail : undefined,
          address: body.address !== undefined ? body.address : undefined,
          fatherName: body.fatherName !== undefined ? body.fatherName : undefined,
          motherName: body.motherName !== undefined ? body.motherName : undefined,
          leetcodeUrl: body.leetcodeUrl !== undefined ? body.leetcodeUrl : undefined,
          kaggleUrl: body.kaggleUrl !== undefined ? body.kaggleUrl : undefined,
          hackerrankUrl: body.hackerrankUrl !== undefined ? body.hackerrankUrl : undefined,
          portfolioWebsiteUrl: body.portfolioWebsiteUrl !== undefined ? body.portfolioWebsiteUrl : undefined,
          languages: body.languages !== undefined ? (typeof body.languages === 'string' ? body.languages : JSON.stringify(body.languages)) : undefined,
          interests: body.interests !== undefined ? (typeof body.interests === 'string' ? body.interests : JSON.stringify(body.interests)) : undefined,
        },
      });
