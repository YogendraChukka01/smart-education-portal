      ...
      <header className="rounded-3xl border border-slate-200 bg-white p-7 shadow-sm">
        <div className="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-5">
          <div>
            ...
            <p className="mt-2 max-w-3xl text-sm leading-6 text-slate-500">EduBridge now converts opportunity requirements into an explainable skill-demand signal and compares it with observed student proficiency. Use it to prioritize curriculum, assessments and placement preparation.</p>
          </div>
